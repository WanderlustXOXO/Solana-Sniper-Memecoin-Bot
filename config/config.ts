...
// ✅ NEW: BUY AMOUNT CONFIG
export const BUY_AMOUNT_SOL = parseFloat(retrieveEnvVariable('BUY_AMOUNT_SOL', logger));

// ✅ Trade safety toggles
...
export const solanaSubcribeConnection = new Connection(RPC_SUB_ENDPOINT, {
  wsEndpoint: WEBSOCKET_SUB_ENDPOINT,
  commitment: "confirmed"
});
export const devConnection = new Connection(DEV_NET_RPC, {
  wsEndpoint: DEV_NET_WSS,
  commitment: "confirmed"
});
export const devSubcribeConnection = new Connection(DEV_NET_SUB_RPC, {
  wsEndpoint: DEV_NET_SUB_WSS,
  commitment: "confirmed"
});
